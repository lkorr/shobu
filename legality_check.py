...
def print_statements(init_stone, init_move, aggro_stone, aggressive_moved, aggro_legal, passive_legal, unit_vector, opponent):
...
def passive_aggressive(color,init_stone,init_move,aggro_stone):
    ...
    print_statements(init_stone, init_move, aggro_stone, aggressive_moved, aggro_legal, passive_legal, unit_vector, opponent)
    return True
